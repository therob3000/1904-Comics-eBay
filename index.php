     ...
     <div class="row">
        <div class="col-md-5">
          <div class="panel panel-primary">
            <div class="panel-heading">RAW - Item Description</div>
              ...
              <form role="form">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="bookPublisher" ng-model="bookPublisher" placeholder="Publisher">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
